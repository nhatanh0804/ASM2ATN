	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto">
			...
			<li class="nav-item dropdown">
				<a class="nav-link dropdown-toggle" href="view.php" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
					Admin
				</a>
		...
		<div class="col col-8">
			<form action="" method="post" enctype="multipart/form-data">
				...
				<div class="form-group">
					...
					<input type="file" name="ProductImage" id="priceproduct" value="<?php if(isset($_GET['update_id'])){echo "$row->ProductImage";} ?>" class="form-control">
				</div>
				<div class="form-group">
